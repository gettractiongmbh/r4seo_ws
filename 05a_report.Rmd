...
```{r}
# Anzeigen der Code-Snipptes, Lade-Benachrichtigungen und Warnungen deaktivieren
...
Report für die Domain **`r SISTRIX_DOMAIN`** vom **`r START_DATE`** bis **`r END_DATE`**
...
**Die stärksten Seiten nach Clicks der Vorwoche (KW `r isoweek(MONDAY_PREVIOUS_WEEK)`)**

```{r}
knitr::kable(gsa_top_10_pages,
             format = "markdown",
...
**Die stärksten Suchanfragen nach Clicks der Vorwoche (KW `r isoweek(MONDAY_PREVIOUS_WEEK)`)**

```{r}
knitr::kable(gsa_top_10_queries,
             format = "markdown",
             format.args = list(big.mark = ".",
                                decimal.mark = ","),
             digits = 2)
